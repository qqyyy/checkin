...
Page({
  data: {
    ...
    display1: 'none',
    mask1:'none',
    mp3: 'http://bmob-cdn-21982.b0.upaiyun.com/2018/10/28/e50dab50400040d48063c9786f0b087f.mp3',
              ...
              complete: function (res) {
                ...
                if (res.status ==373)//位置获取失败
                {
                  ...
                  if (distance >145) {//最大距离是偏离145米，
                    ...
                    if ((getworktime-nowtime>5)||(getworktime-1<nowtime)){
                      wx.hideLoading();
                      wx.showModal({
                        title: '提示',
                        content: '不在签到时间区间，继续签到将无效',
                        success: function (res) {
                          if (res.confirm) {
                            wx.showLoading({
                              title: '加载中',
